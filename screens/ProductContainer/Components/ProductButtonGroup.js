    ...
    <View style={styles.assistantButtonGroupContainer}>
        ...
        <Modal visible={props.modalVisible} animationType="fade">
          <View style={styles.modalContainer}>
            ...
            <TouchableOpacity
              onPress={() =>
                props.handleSortByChangeMethod({ key: "userName", value: "Name" })
              }
            >
              <Text style={styles.sortOptionText}>User Name</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => props.handleSortByChangeMethod({ key: "rate", value: "Rate" })}
            >
              <Text style={styles.sortOptionText}>Rate</Text>
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() =>
                props.handleSortByChangeMethod({ key: "createdDate", value: "Date" })
              }
            >
